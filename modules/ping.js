function ping(msg, args, ctx) {
    const pongMsgPool = [
        ...
        'what does that mean',
        'poggers',
        '<:YeetAary:664279299255435267>',
        'now you\'re thinking with portals',
        'stop poking me',
        `Pong!, ${msg.member.id / 2}ms`,
        `Pong!, ${msg.member.id / 4}ms`,
        `Pong!, ${msg.member.id / 32}ms`,
        `Pong!, -${msg.member.id / 1.5}ms`,
        'stop fucking pinging me omg',
        'https://cdn.discordapp.com/attachments/191264724657111040/712512407255122000/iu.png',
    ];
...
module.exports = [{
    ...
    func: ping,
    command: {
        aliases: ['ping', 'p', 'pong', 'pingpong', ':ping_pong:', 'peng', 'pang', 'png', 'pinng'],
    },
}];
